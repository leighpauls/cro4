function DiffDomEncoder(updateHandler) {
    ...
    this.rootJNode = this.createJNodeElement(document.documentElement);
    var rootId = this.rootJNode.id;
	this.jNodeMap = {};
    this.jNodeMap[rootId] = this.rootJNode;
...
DiffDomEncoder.prototype.getLastFullStateDiff = function() {
    return [DiffDomEncoder.getSendableDiffEntry(this.rootJNode)];
};
...
DiffDomEncoder.prototype.doDiff = function(rootJNodes) {
    ...
    rootJNodes = rootJNodes || [this.rootJNode];
    ...
    function compareAndUpdateElement(jNode) {
        var changed = false,
            curAttrName, curAttrDomValue, curDomAttr, domChildren = jNode.domNode.childNodes,
